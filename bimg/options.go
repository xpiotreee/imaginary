...
type Options struct {
	...
	InputICC       string
	Palette        bool
	// DPI defines the resolution for PDF/SVG rasterization.
	// When set to a value > 0, it is passed to libvips's pdfload/svgload
	// to control the rasterization density (dots per inch).
	DPI int
